...
<body>
    ...
    <h1><a href="index.html"><img src="css/pics/icon.png" id="icon"/></a>Lewis Gavin<br>
    ...
    <div id="nav"><a href="posts.php">Home</a><a href="createpost.php">Submit Post</a><a href="index.html">About Me</a></div>
